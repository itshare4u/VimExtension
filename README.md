...
![VsVimExtension](./Icon.png)

This extension helps you hard code your input method automatically when using VSCodeVim.

# Installation

To use this extension, you need to install the switch input tool and add the following configuration to your `settings.json`:
